...
exports.taskToggleDone = exports.renderTasks = exports.renderTaskEdit = exports.editTask = exports.deleteTask = exports.createTask = exports.about = void 0;
...
var renderTasks = exports.renderTasks = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var tasks, tasksWithIncrementedIndex;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          tasksWithIncrementedIndex = tasks.map(function (task, index) {
            return _objectSpread(_objectSpread({}, task), {}, {
              displayIndex: index + 1
            });
          }); // res.render('index', { tasks: tasks });
          res.render('index', {
            tasks: tasksWithIncrementedIndex
          });
          _context.next = 11;
          break;
        case 8:
  ...
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          id = req.params.id;
          taskUpdated = req.body;
          _context4.next = 4;
          return _Task["default"].findByIdAndUpdate(id, taskUpdated);
        case 4:
          res.redirect('/');
        case 5:
        case "end":
